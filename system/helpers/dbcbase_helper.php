...
if ( ! function_exists('get_per_page_value_admin'))
{
	function get_per_page_value_admin()
	{
		return get_settings('site_settings','per_page_admin',20);		
	}
}
...
if ( ! function_exists('create_log'))
{
	...
	{		
		...
		$domain = base_url();
		if (!strpos('-'.$domain, "localhost/cars.rhodonitestore.com/"))
		{
			//set POST variables
