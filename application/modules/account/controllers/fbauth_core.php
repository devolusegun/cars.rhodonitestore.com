...
class Fbauth_core extends MX_Controller {
	...
	public function __construct()
	{
		...
		$CI 	= & get_instance();
		$appId 	= get_settings('autocon_settings','fb_app_id','none');
		$secret = get_settings('autocon_settings','fb_secret_key','none');
	...
	public function send_confirmation_email($data=array('username'=>'sc mondal','useremail'=>'info@rhodonitestore.com','confirmation_key'=>'1234'))
	{
		$val = $this->get_admin_email_and_name();
		$admin_email = $val['admin_email'];
		$admin_name  = $val['admin_name'];
