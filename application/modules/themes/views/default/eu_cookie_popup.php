<div id="cookiescript-popup" style="display:none">
   <div id="cookiescript-wrapper" style="">
      ...
      <a href="<?php echo site_url(get_settings('autocon_settings','cookie_policy_page_url',''));?>" class="btn btn-info" style="padding:8px 8px"><?php echo lang_key('read_more');?></a>
      <a href="#" class="btn btn-success agree-cookie" style="padding:8px 8px"><?php echo lang_key('i_agree');?></a>
