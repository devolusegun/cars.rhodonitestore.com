...
<rss version="2.0"
    ...
    <atom:link href="<?php echo site_url('show/rss');?>" rel="self" type="application/rss+xml" />
    ...
    <?php foreach($posts->result() as $post): ?>
        ...
        <item>
          ...
          <guid><?php echo $detail_link; ?></guid>
            ...
            <enclosure length="250" url="<?php echo  get_featured_photo_by_id($post->featured_img)?>" type="image/<?php echo $type;?>" />
