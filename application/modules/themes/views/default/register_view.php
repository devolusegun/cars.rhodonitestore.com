                        ...
                        <div class="panel-body">
                            <?php if(get_settings('autocon_settings','enable_pricing','Yes')=='Yes'){?>    
                                ...
                                <div class="thumbnail thumb-shadow">                                    
                                    <div class="caption">
                                        ...
                                        <p><?php echo lang_key($package->description);?></p>                       
                            ...
                            <div style="height: 1px; background-color: #fff; text-align: center">
                              <span style="background-color:#fff; position: relative; top: -12px; font-size:16px;padding:0px 8px;">
                               <?php echo lang_key('signup_with_social_accounts');?>
                              </span>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <label class="checkbox">
                                            ...
                                            <?php echo lang_key('i_have_read');?> <a target="_blank" href="<?php echo site_url('show/terms');?>"><?php echo lang_key('terms_conditon');?></a>
                                        </label>
