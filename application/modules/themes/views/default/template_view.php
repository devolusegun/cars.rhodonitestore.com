...
<head>
    ...
    else
    {
        ...
        {
            $page_title = translate(get_settings('site_settings', 'site_title', 'Autocon')).'|'.translate(lang_key($sub_title));
            $fb_app_id = get_settings('autocon_settings','fb_app_id','none');

    ?>
    <meta name="description" content="<?php echo $meta_desc; ?>">
    <meta name="keywords" content="<?php echo $key_words; ?>"/>
    <meta property="og:title" content="<?php echo $page_title;?>" />
    <meta property="og:site_name" content="<?php echo get_settings('site_settings','site_title','autocon');?>" />
    <meta property="og:url" content="<?php echo get_the_current_url();?>" />
    <meta property="og:description" content="<?php echo $meta_desc;?>" />
    <meta property="og:type" content="article" />
    <?php  if($fb_app_id!='' && $fb_app_id!='none'){ ?>
    <meta property="fb:app_id" content="<?php echo get_settings('autocon_settings','fb_app_id','none');?>" />
    <?php }?>
    <?php
        }
    }
