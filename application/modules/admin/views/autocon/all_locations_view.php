...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo site_url('admin/autocon/newlocation/country');?>" class="btn btn-success add-location">Add Country</a>
    <?php if(get_settings('autocon_settings','show_state_province','yes')=='yes'){?>
    <a href="<?php echo site_url('admin/autocon/newlocation/state');?>" class="btn btn-info add-location">Add State</a>
    <?php }?>
    <a href="<?php echo site_url('admin/autocon/newlocation/city');?>" class="btn btn-warning add-location">Add City</a>
                  ...
                  <td data-title="Action" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/autocon/editlocation/'.$row->type.'/'.$row->id);?>" class="edit-location">Edit</a></li>
                          <li><a href="<?php echo site_url('admin/autocon/deletelocation/'.$curr_page.'/'.$row->id);?>">Delete</a></li>
