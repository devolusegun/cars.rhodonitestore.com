           ...
           <tbody>
        	...
        	<?php $i=$start+1;foreach($posts->result() as $row):  ?>
               ...
               <tr>
                  ...
                  <td data-title="Price" class="numeric"><?php echo show_price($row->price);?></td>
                  ...
                  <td data-title="Action" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          <li><a target="_blank" href="<?php echo site_url('show/detail/'.$row->unique_id.'/'.url_title(get_title_for_edit_by_id_lang($row->id,$dl)));?>"><?php echo lang_key('view_listing');?></a></li>
                          <?php if($row->status!=0){?>
