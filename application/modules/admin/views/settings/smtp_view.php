<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i><?php echo lang_key("Smtp email settings") ?> </h3>
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/system/savesmtpemailsettings');?>" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp email'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp host'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp port'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp timeout'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp user'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Smtp password'); ?></label>
