            ...
            <div class="widget">
                ...
                <div class="thumbnail thumb-shadow widget-listing">
                    ...
                    <div class="caption" style="padding: 2px;">
                        ...
                        <span class="property-address" style=""><?php echo get_brand_model_name_by_id($row->brand).' '.get_brand_model_name_by_id($row->model);?></span>,                         <span class="property-address" style=""><?php echo lang_key($row->car_type);?></span>,                         <span class="property-price" style=""><?php echo show_price($row->price);?></span>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <?php
